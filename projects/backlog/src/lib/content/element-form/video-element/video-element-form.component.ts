...
@Component({
    selector: 'io-video-element-form',
    templateUrl: 'video-element-form.component.html',
    styleUrls: ['video-element-form.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class VideoElementFormComponent implements OnChanges, OnDestroy, BacklogElementForm<RemoteBacklogElement> {
    ...
    constructor(private fb: FormBuilder) {
        this.formGroup = this.fb.group({
            ...
            typeId: [BacklogElementTypeId.VIDEO, [Validators.required]],
